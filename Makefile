...
# DEPENDENCIES:
bl_gwdo.o: ../ccpp_kinds.o

bl_ysu.o: ../ccpp_kinds.o

cu_ntiedtke.o: ../ccpp_kinds.o

mp_radar.o: ../ccpp_kinds.o

mp_wsm6_effectRad.o: mp_wsm6.o

mp_wsm6.o: module_libmassv.o mp_radar.o ../ccpp_kinds.o

sf_sfclayrev.o: ../ccpp_kinds.o

../ccpp_kinds.o: ../machine.o
