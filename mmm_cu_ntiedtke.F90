 ...
 implicit none
 private
 public:: mmm_cu_ntiedtke_run,     &
          mmm_cu_ntiedtke_init,    &
          mmm_cu_ntiedtke_finalize
...
!!
 subroutine mmm_cu_ntiedtke_init(con_cp,con_rd,con_rv,con_xlv,con_xls,con_xlf,con_grav,errmsg,errflg)
!=================================================================================================================
   ! implicit none
!input arguments:
...
!-----------------------------------------------------------------------------------------------------------------
 ...
 errmsg = 'mmm_cu_ntiedtke_init OK'
 errflg = 0

 end subroutine mmm_cu_ntiedtke_init

!=================================================================================================================
!> \section arg_table_mmm_cu_ntiedtke_finalize Argument Table
!! \htmlinclude mmm_cu_ntiedtke_finalize.html
!!
 subroutine mmm_cu_ntiedtke_finalize(errmsg,errflg)
!=================================================================================================================
...
!-----------------------------------------------------------------------------------------------------------------
 ...
 errmsg = 'mmm_cu_ntiedtke_finalize OK'
 errflg = 0

 end subroutine mmm_cu_ntiedtke_finalize

!=================================================================================================================
!> \section arg_table_mmm_cu_ntiedtke_run Argument Table
!! \htmlinclude mmm_cu_ntiedtke_run.html
!!
!     level 1 subroutine 'mmm_cu_ntiedkte_run'
      subroutine mmm_cu_ntiedtke_run(pu,pv,pt,pqv,pqc,pqi,pqvf,ptf,poz,pzz,pomg, &
...
!--- inout arguments:
      ...
      real(kind=kind_phys),intent(inout),dimension(:,:):: pu,pv,pt,pqv,pqi
      real(kind=kind_phys),intent(inout),dimension(:,:):: pqc
...
!
      errmsg = 'mmm_cu_ntiedtke_run OK'
      errflg = 0
!
      return
      end subroutine mmm_cu_ntiedtke_run
